...
export default function PasswordPromptModal() {
    ...
    if (!auth.show_password_prompt) {
        return null;
    }

    const handleDismiss = (e: React.FormEvent) => {
        e.preventDefault();
        postDismiss(route('password.prompt.dismiss'), { preserveScroll: true });
    };
                ...
                {!showForm ? (
                    <>
                        <div className="text-center mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900">Change your password</h2>
                            <p className="text-slate-500 mt-2 text-sm">
                                You are using a temporary password. Create your own password now, or skip until the next login. This reminder appears every time you sign in until you change it.
                            </p>
                        </div>

...
export default function Show({ blotter }: { blotter: BlotterDetail }) {
    ...
    // Function to trigger the backend approval
    const handleApprove = () => {
        ...
        <AdminLayout title="Review Blotter">
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Submitted on {blotter.created_at}</p>
                </div>
                <div>
                ...
                <div className="md:col-span-2 space-y-6">
                    <Card className="shadow-sm">
                        <CardContent className="p-6">
                            ...
                            <p className="text-slate-700 whitespace-pre-wrap">{blotter.narrative}</p>
                            
                            <h3 className="mt-6 mb-3 text-lg font-semibold text-blue-900">Relief Sought</h3>
                            <p className="text-slate-700 whitespace-pre-wrap">{blotter.relief_sought}</p>
                        </CardContent>
                    </Card>
                        ...
                        <Card className="border-emerald-200 bg-emerald-50 shadow-sm">
                            <CardContent className="p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                                <div>
                                    ...
                                    <p className="text-sm text-emerald-800">Review the statement above. Approving this will generate an official ticket number.</p>
                                </div>
                ...
                <div className="space-y-6">
                    <Card className="shadow-sm">
                        <CardContent className="p-6 space-y-4">
                            <div>
                                <p className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Blotter Type</p>
                                <p className="font-medium text-slate-900">{blotter.type}</p>
                            </div>
                            <div className="border-t pt-4">
                                <p className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Complainant</p>
                                <p className="font-medium text-blue-700">{blotter.complainant}</p>
                            </div>
                            <div className="border-t pt-4">
                                <p className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Respondent</p>
                                <p className="font-medium text-red-700">{blotter.respondent}</p>
                            </div>
                            <div className="border-t pt-4">
                                <p className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Incident Date</p>
                            ...
                            <div className="border-t pt-4">
                                ...
                                <p className="text-slate-900">{blotter.location}</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>

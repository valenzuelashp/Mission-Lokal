...
export default function AdminFullMap({
    ...
    return (
        <div className={className}>
            <div className="relative h-full min-h-[400px] overflow-hidden rounded-xl border bg-card shadow-sm">
                ...
                <div className="pointer-events-none absolute bottom-4 left-4 z-[400] rounded-md border border-slate-200 bg-white/95 px-3 py-2 text-xs text-slate-700 shadow-sm">
                    <p className="font-medium">{pins.length} map pins visible</p>
                    {showHotspots && <p className="mt-0.5 text-muted-foreground">{hotspots.length} active hotspot zones</p>}
                </div>

                <div className="pointer-events-none absolute right-4 top-4 z-[400] rounded-md border border-slate-200 bg-white/95 px-3 py-2 text-xs text-slate-700 shadow-sm">
                    <p className="mb-1.5 text-[11px] font-medium text-muted-foreground">Severity</p>
